...
<section style="padding:96px 32px 0;max-width:1200px;margin:0 auto;position:relative;">
    ...
    {{-- Ticker badge --}}
    <div class="reveal" style="display:inline-flex;align-items:center;gap:8px;padding:6px 16px;border-radius:30px;border:1px solid rgba(0,200,150,0.2);background:rgba(0,200,150,0.06);font-size:12px;color:var(--teal);margin-bottom:40px;">
        <span style="width:5px;height:5px;border-radius:50%;background:var(--teal);display:inline-block;animation:pulse-dot 2s ease-in-out infinite;flex-shrink:0;"></span>
        ↗ 2,400 firms joined last month
    </div>

    {{-- Main headline --}}
    <h1 class="reveal" style="font-size:clamp(40px,5.5vw,64px);font-weight:300;line-height:1.05;letter-spacing:-0.04em;max-width:720px;margin-bottom:24px;">
    ...
    <div class="reveal" style="display:flex;align-items:center;gap:16px;margin-bottom:32px;flex-wrap:wrap;">
        ...
        <a href="{{ route('register') }}" style="display:inline-flex;align-items:center;gap:8px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.1);color:var(--text-2);padding:12px 24px;border-radius:10px;font-size:15px;text-decoration:none;transition:all 150ms ease;">
            Are you a firm? Join free →
        </a>
    </div>

    {{-- Trust indicator --}}
    <div class="reveal" style="font-size:13px;color:var(--text-3);display:flex;align-items:center;gap:10px;padding-bottom:96px;">
...
<section style="max-width:1200px;margin:0 auto;padding:0 32px 96px;">
    <div class="reveal" style="display:flex;align-items:center;border-top:1px solid rgba(255,255,255,0.06);border-bottom:1px solid rgba(255,255,255,0.06);">
        @foreach([
            ['2400','+','2,400+','Verified firms'],
            ['48','h','48h','Avg. proposal time'],
            ['94','','94','Countries'],
            ['340','M+','$340M+','Contracts facilitated'],
...
<section style="padding:0 32px 96px;max-width:1200px;margin:0 auto;">
    ...
    <div style="display:flex;flex-wrap:wrap;gap:16px;margin-bottom:16px;">
        ...
        <div class="reveal" style="flex:0 0 calc(60% - 8px);min-width:280px;background:var(--bg-surface);border:1px solid rgba(255,255,255,0.06);border-radius:12px;padding:40px;box-shadow:inset 0 1px 0 rgba(255,255,255,0.08);transition:border-color 200ms ease,box-shadow 200ms ease;" onmouseover="this.style.borderColor='rgba(0,200,150,0.2)';this.style.boxShadow='0 8px 32px rgba(0,200,150,0.08),inset 0 1px 0 rgba(255,255,255,0.1)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.06)';this.style.boxShadow='inset 0 1px 0 rgba(255,255,255,0.08)'">
            <div style="display:flex;align-items:flex-start;gap:24px;">
                <div style="width:48px;height:48px;border-radius:12px;background:rgba(0,200,150,0.1);border:1px solid rgba(0,200,150,0.2);display:flex;align-items:center;justify-content:center;flex-shrink:0;">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#00C896" stroke-width="1.5" stroke-linecap="round"><path d="M11 4H4a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 013 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>
                </div>
                <div>
        ...
        <div class="reveal" style="flex:0 0 calc(40% - 8px);min-width:240px;background:var(--bg-surface);border:1px solid rgba(255,255,255,0.06);border-radius:12px;padding:32px;box-shadow:inset 0 1px 0 rgba(255,255,255,0.08);transition:border-color 200ms ease,box-shadow 200ms ease;margin-top:24px;" onmouseover="this.style.borderColor='rgba(0,200,150,0.2)';this.style.boxShadow='0 8px 32px rgba(0,200,150,0.08),inset 0 1px 0 rgba(255,255,255,0.1)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.06)';this.style.boxShadow='inset 0 1px 0 rgba(255,255,255,0.08)'">
            ...
            <div style="font-size:13px;color:var(--text-2);line-height:1.65;">Verified firms matching your brief respond with tailored proposals. Not auto-generated quotes — real responses from real people.</div>
        </div>
    </div>
    ...
    <div class="reveal" style="width:50%;margin:0 auto;min-width:280px;background:var(--bg-surface);border:1px solid rgba(255,255,255,0.06);border-radius:12px;padding:36px;box-shadow:inset 0 1px 0 rgba(255,255,255,0.08);transition:border-color 200ms ease,box-shadow 200ms ease;" onmouseover="this.style.borderColor='rgba(0,200,150,0.2)';this.style.boxShadow='0 8px 32px rgba(0,200,150,0.08),inset 0 1px 0 rgba(255,255,255,0.1)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.06)';this.style.boxShadow='inset 0 1px 0 rgba(255,255,255,0.08)'">
        <div style="display:flex;align-items:flex-start;gap:20px;">
            <div style="width:44px;height:44px;border-radius:12px;background:rgba(0,200,150,0.1);border:1px solid rgba(0,200,150,0.2);display:flex;align-items:center;justify-content:center;flex-shrink:0;">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#00C896" stroke-width="1.5" stroke-linecap="round"><polyline points="9 11 12 14 22 4"/><path d="M21 12v7a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h11"/></svg>
            </div>
            <div>
...
{{-- ═══════════════════════ CTA BAND ═══════════════════════ --}}
<section style="padding:96px 32px;text-align:center;border-top:1px solid rgba(255,255,255,0.06);position:relative;overflow:hidden;">
